...
class BaseRepository implements BaseRepositoryInterface
{
     ...
     * @inheritDoc
     */
    public function findWhereLike(string $attribute, $value, int $limit = 10)
    {
     ...
     * @inheritDoc
     */
    public function paginate($columnName, $columnSortOrder, $searchValue, $start, $rowPerPage, $column, string $status = 'status')
    {
        // table name
        $table = $this->model->getTable();
